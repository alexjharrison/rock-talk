...
export const CreatePostDocument = gql`
    mutation CreatePost($object: post_insert_input!, $on_conflict: post_on_conflict) {
  insert_post_one(object: $object, on_conflict: $on_conflict) {
    id
  }
}
    `;
...
export const PostsDocument = gql`
    query Posts($distinct_on: [post_select_column!], $limit: Int, $where: post_bool_exp, $order_by: [post_order_by!]) {
  post(
